 ...
 * @date 2012-4-29
 */
public class IntegrityPerfomance {
	 ...
	 */
	// ArrayList<>
	public IntegrityPerfomance(String arg) {
	...
	public int processNewFile(File file) throws Exception {
		...
		// HelpFunctions.moveFile(file, dataDir);
		return result;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		IntegrityPerfomance integrityCheck = new IntegrityPerfomance("MD5");
